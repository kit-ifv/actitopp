...
class CoordinatorStep5BTest : CoordinatorTestUtilities() {


    @TestFactory
    fun coordinatedStep5BActualCode(): Collection<DynamicTest> {
            ...
            DynamicTest.dynamicTest("${person.household.householdIndex} main Activities") {
                ...
                person.weekPattern.days.forEach { day ->
                    day.tours.forEach { tour ->
                        ...
                        val modernProbabilities = step5BWithParams.probabilities {
