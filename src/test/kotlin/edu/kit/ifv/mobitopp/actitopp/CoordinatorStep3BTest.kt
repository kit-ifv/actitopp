...
//                val actual = GenerateSideToursFollowing(
//                    rngCopy,
//                    plannedTourMap = PlannedTourMap(boundDays.map { it.day })
//                ).debugInfo(person, weekRoutine, boundDays)
//
//
...
//    }
//
//    private fun generateStep3BUtilitiies(
//        person: ActitoppPerson,
//        routine: WeekRoutine,
//        day: HDay,
//        previousDay: HDay?,
